...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to Youtube Music. ask to play a video to start listening.';
        const reprompt = "You can say, play Choker by Twenty One Pilots, to begin."
  ...
  const GetVideoIntentHandler = {
    ...
    handle(handlerInput) {
      ...
      if (speechText) {
        ...
        return handlerInput.responseBuilder
          .speak("You can say, play Twenty One Pilots, to begin.")
          .getResponse();
      }
    },
  };
